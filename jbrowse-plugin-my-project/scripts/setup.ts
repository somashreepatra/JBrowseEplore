...
async function updateJBrowseConfig(packageName: string, pluginName: string) {
  ...
  jbrowseConfig.plugins[0].url = `http://localhost:8999/dist/${packageName}.umd.development.js`
...
async function updateExampleFixture(packageName: string, pluginName: string) {
  ...
  exampleFixture.plugins[0].url = `http://localhost:8999/dist/${packageName}.umd.development.js`
